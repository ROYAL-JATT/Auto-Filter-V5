...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/MOVIES_VILLA_UPDATE'),
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/Movies_villa_support')
                  ]]
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_photo(
            photo="https://telegra.ph/file/34f5242890236c69f5d36.jpg",
